...
$request = $connexion->prepare("SELECT * FROM review ORDER BY rand() LIMIT $a");
$request->execute();

$resultat = $request->fetchAll();

$retour["message"] = "Liste des avis";
$retour["retour"] = $resultat;

$json = json_encode($retour);

if (file_put_contents("review.json", $json))
header('location:https://toreya.fr/admin/add-service?msg=success');
